...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::attachments::read_attachment_file,
            commands::attachments::save_history_attachments,
            commands::attachments::export_history_attachment,
            commands::attachments::read_history_attachment,
