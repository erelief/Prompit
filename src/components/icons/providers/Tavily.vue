<template>
  <!--
    Tavily brand mark. Source: assets/.sourcefiles/tavily.svg.
    Monochrome via currentColor (matches the provider icon convention).
  -->
  <svg :width="size" :height="size" viewBox="0 0 24 24" fill="currentColor" fill-rule="evenodd" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
